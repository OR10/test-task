...
class Version20180209113243 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE position (position_id INT AUTO_INCREMENT NOT NULL, position_name VARCHAR(150) NOT NULL, PRIMARY KEY(position_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB');
